...
// #include "ill_handler.h"

// unsigned long long cc = 0;
unsigned long long cc = 0x0000222222222222LL;
...
int main()
{
	...
	mmx_t ma;
	mmx_t mb;
// On trifouille la FPU pour voir s'il y a de la vie dans les registres :-)
/*
	long double a = 0.0;
	long double c = 1.0 * (long double) cc;
	printf ("%f\n", c);
*/
